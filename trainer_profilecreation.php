		...
		<div class="container">
			<div class="outer">
				...
				<div class="details">
					...
					<h1>Trainer</h1>
						<div class="textbox">
								...
								<input type="text" name="fname" disabled="true" placeholder="(Name)<?php echo $fname; ?> <?php echo $lname; ?>">
							</div> 
							...
							<div class="textbox">
								<i class="fas fa-lock"></i>
								<input type="number" name="monrate" placeholder="Monthly Rate">
							</div>
							<div class="textbox">
								<i class="fas fa-lock"></i>
								<input type="number" name="semirate" placeholder="Semi-Annual Rate">
							</div>
							<div class="textbox">
								<i class="fas fa-lock"></i>
								<input type="number" name="anrate" placeholder="Annual Rate">
							</div>	
							<div class="textbox">
								<i class="fas fa-lock"></i>
							...
							<div class="textbox">
								...
								<label for="description" style="vertical-align: top;">Description:</label>
              				    <textarea rows="2" cols="60" name="description" id='description'>Enter Your Professional Experiences Here</textarea>
							</div>
				...
				<div>
						...
						<!-- <label for="files" class="images" style="margin-top: 20%; margin-left:5%; color: white">Click <b>"HERE"</b> To</label> -->
